...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-datta-1745071214) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-datta-1745071214.git
$ cd django-datta-1745071214
```
